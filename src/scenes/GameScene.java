...
public class GameScene extends Scene {
    ...
    /**
     * This is a constructor for the `GameScene` class that takes in an instance of
     * `PApplet` and the
     * width and height of the scene. It calls the constructor of the parent `Scene`
     * class with the
     * `applet` and creates an image with the specified width and height using
     * `applet.createImage()`.
     * It also initializes a new `BoundsLogic` object with the same width and
     * height.
     */
    ...
    /**
     * The function initializes a player object with a given position and sets it up
     * in a PApplet
     * environment.
     *
     * @param applet The applet parameter is an instance of the PApplet class, which
     *               is the main class for
     *               processing sketches. It is used to access various methods and
     *               properties of the Processing
     *               environment, such as the width and height of the sketch window.
     *               In this case, it is passed to the
     *               Player constructor and
     * @return The method `InitializePlayer` is returning an instance of the
     *         `Player` class that has been
     *         initialized with the `setup` method and positioned at the center of
     *         the `applet` window.
     */
    ...
    /**
     * The `drawScene()` method is responsible for updating and rendering the game
     * scene. It first updates
     * the score label with the current high score value. Then, it handles the
     * constraints of all game
     * objects using the `_boundsLogic` object. It then moves and updates the
     * direction of the alien
     * convoy using the `_convoy` object. It then updates the attacking enemies
     * using the
     * `updateAttackingEnemies()` method, detects collisions using the
     * `detectCollision()` method, and
     * checks for dead enemies using the `checkDeadEnemies()` method. Finally, it
     * calls the `drawScene()`
    ...
    /**
     * The function starts an attack by creating a timer that periodically creates a
     * projectile aimed at
     * the player's position.
     *
     * @param applet The PApplet object that is used to draw the game and handle
     *               user input.
     * @param player The player parameter is an instance of the Player class, which
     *               represents the player
     *               character in the game. It is used in the startAttack method to
     *               calculate the angle at which the
    ...
    /**
     * This function updates the attacking enemies' velocity towards the player's
     * position.
     */
    ...
    /**
     * This function builds a health counter by creating a stack of UIImage objects
     * representing the
    ...
    /**
     * The function builds the game scene by creating enemies, a highscore display,
     * and a timer that drops
     * aliens periodically.
     */
    ...
    /**
     * This function builds a high score label and displays the current high score
     * in a separate label.
     */
    ...
    /**
     * The function detects collisions between projectiles and enemies, and between
     * the player and aliens,
