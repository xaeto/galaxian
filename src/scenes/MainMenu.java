...
public class MainMenu extends Scene {
  ...
  /**
   * This function increases the player count by advancing the selector in a list
   * menu.
   */
  ...
  /**
   * This function decreased the player count by advancing the selector in a list
   * menu.
   */
  ...
  /**
   * The `initializeGame()` method is returning the current index of the
   * `_listMenu` UIListMenu
   * object incremented by 1. This is used to determine the number of players
  ...
  /**
   * This function builds a UI list menu with two options for selecting the number
   * of players in a
   * game.
   */
  private void buildPlayerSelection() {
    ...
    var _listMenu_selector = new UIListMenuSelector(
        this._applet,
        _listMenu.getX() - 64,
  ...
  /**
   * This is overriding the `buildScene()` method from the parent class `Scene`.
   * It first calls the
   * `buildPlayerSelection()` and `buildHighScore()` methods to build the UI
   * components for the main
   * menu scene, and then calls the `buildScene()` method from the parent class to
   * register all the
  ...
  /**
   * This function overrides the drawScene method and calls the drawScene method
   * of the superclass.
   */
  @Override
