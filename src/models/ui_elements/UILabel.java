...
public class UILabel extends UIComponent {
  private final ArrayList<UILabelSymbol> symbols = new ArrayList<>();
  ...
  public void buildComponent() {
    ...
    for (int i = 0; i < this._text.length(); ++i) {
      ...
      MultiSprite sprite =
          new MultiSprite(
              TextureConstants.TextWidth, TextureConstants.TextHeight, ANCHORTYPE.TOP_LEFT);
      ...
      if (i >= 0) next_x += TextureConstants.GridGap;
      ...
      var point =
          new Point(
              ...
              (int) this.getY());
      var symbol = new UILabelSymbol(sprite, point);
