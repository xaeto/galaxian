...
public class GreenAlien extends Alien {
  ...
  public void setup(PApplet applet) {
    ...
    // add default frames
    seqSprite.addFrames(
        applet, img, TextureConstants.GreenEnemyOffsetX, TextureConstants.GreenEnemyOffsetY, 2);
    // add explosion frames
    seqSprite.addFrames(
        applet, img, TextureConstants.GridGap, TextureConstants.ExplosionOffsetY, 4);
